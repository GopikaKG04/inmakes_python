...
display = Entry(root)  # inputbox
display.grid(row=1, columnspan=6, sticky=W + E)  # input box set
# code
i = 0
...
def get_variable(num):
    ...
    i = +1
    # button clicking time delete all code
...
# design-add button to calculator
